<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:82:"F:\myphp_www\PHPTutorial\WWW\zjb\public/../application/admin\view\login\login.html";i:1515638105;}*/ ?>
<!DOCTYPE html>
...
<body class="login">
	<div class="logo">
		...
		<!-- <img src="/public/static/admin/image/logo-big.png" alt="" />  -->
	...
	<script src="/public/static/admin/js/login.js" type="text/javascript"></script>      
