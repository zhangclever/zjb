...
<div id="page-wrap">
    ...
    <section class="section bg-white pt-60 pb-60">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="section-header">Emergency <span>Care</span></div>
                    <div class="post-thumbnail hover-link">
                        <img src="/static/home/img/service/1.jpg" alt=""/>
                        <a href="#" class="overlay"><i class="ilmosys-link-2"></i></a>
                    </div><!--/ post-thumbnail -->
                    <div class="mb-30">
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod
                            tincidunt ut laoreet dolore magna aliquam erat volutpat. Ut wisi enim ad minim veniam, </p>
                    </div>
                    <a href="#" class="btn btn-primary radius mb-30">Read more</a>
                </div><!-- /col -->
                <div class="col-md-4">
                    <div class="section-header">Operation <span>Theatre</span></div>
                    <div class="post-thumbnail hover-link">
                        <img src="/static/home/img/service/2.jpg" alt=""/>
                        <a href="#" class="overlay"><i class="ilmosys-link-2"></i></a>
                    </div><!--/ post-thumbnail -->
                    <div class="mb-30">
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod
                ...
                <div class="col-md-4">
                    <div class="section-header">Outdoor <span>Checkup</span></div>
                    <div class="post-thumbnail hover-link">
                        <img src="/static/home/img/service/3.jpg" alt=""/>
                        <a href="#" class="overlay"><i class="ilmosys-link-2"></i></a>
                    </div><!--/ post-thumbnail -->
                    <div class="mb-30">
                        <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod
