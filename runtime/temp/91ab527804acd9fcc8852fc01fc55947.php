                        ...
                        <main id="main">
                            <article class="post format-standard mb-40">
                                <div class="post-thumbnail">
                                    <!-- <img src="/static/admin/uploads/" alt="" /> -->
                                    <!-- <a href="news-single.html" class="overlay"><i class="fa fa-link"></i></a> -->
                                    <span class="latest">视频</span>
                                </div><!--/ post-thumbnail -->

                                <header class="entry-header">
                                    <h2 class="entry-title h4"><a href="news-single.html"><?php echo $content['vname']; ?></a></h2>
                                    <span class="byline">发表 <a href="#">中建宝</a> - </span>
                                    <span class="posted-on"><a href="#"></a> - </span>
                                    <span>张贴<a href="#">在视频管理</a>, <a href="#">重要信息</a></span>
                                </header><!-- /header -->
                                <div class="entry-content">
                                    <p>视频说明:<?php echo $content['descript']; ?></p>
                                    <video width="1000" height="800" controls autobuffer>
                                        <source src="/static/admin/videos/<?php echo $content['vpath']; ?>" type="video/mp4">
                                    </video>
                                    <br/>
                                </div><!-- /entry-content -->
                                </footer><!-- /entry-footer -->
