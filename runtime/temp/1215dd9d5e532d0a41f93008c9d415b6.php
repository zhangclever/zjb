            ...
            <div class="row-fluid ">
                ...
                <div class="" data-tablet="span12 fix-offset" data-desktop="span6">
                    ...
                    <div class="portlet box grey ">
                        ...
                        <label>
                            <form action="<?php echo url('Dynamic/dynamic_list'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                标 题 :
                                <input name="title" type="text" value="<?php echo $title; ?>" aria-controls="sample_1">
