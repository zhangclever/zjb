                ...
                <div class="span12">
                    ...
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i>理赔添加</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form ">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo url('Compensate/compensate_insert'); ?>" id="form_sample_2" enctype="multipart/form-data" method="post" class="form-horizontal">
