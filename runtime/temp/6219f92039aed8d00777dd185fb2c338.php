            ...
            <div class="row-fluid ">
                ...
                <div class="" data-tablet="span12 fix-offset" data-desktop="span6">
                    ...
                    <div class="portlet box grey ">
                        ...
                        <label>
                            <form action="<?php echo url('Article/article_list'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                标 题 :
