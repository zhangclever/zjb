            ...
            <div class="row-fluid ">
                ...
                <div class="" data-tablet="span12 fix-offset" data-desktop="span6">
                    ...
                    <div class="portlet box grey ">
                        ...
                        <label>
                            <form action="<?php echo url('Goods/goods_list'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                搜 索 :
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover table-responsive" id="sample_2">
                                ...
                                <tbody>
                                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$zjb_sp): $mod = ($i % 2 );++$i;?>
                                <tr class="odd gradeX ">
                                    <td style="vertical-align: middle !important;text-align: center;"><?php echo $zjb_sp['number']; ?></td>
                                    <td style="vertical-align: middle !important;text-align: center;"><?php echo $zjb_sp['name']; ?></td>
                                    <td style="vertical-align: middle !important;text-align: center;"><img src="/static/admin/uploads/<?php echo $zjb_sp['imgpath']; ?>/<?php echo $zjb_sp['imgname']; ?>" alt="" width="80"></td>
                                    ...
                                    <td style="vertical-align: middle !important;text-align: center;">
                                        <a href="<?php echo url('Goods/goods_read',array('id'=>$zjb_sp['id'])); ?>"><i class="icon-eye-open"></i>查看</a>
                                        <a href="javascript:js_status(<?php echo $zjb_sp['id']; ?>,<?php echo $zjb_sp['goods_status']; ?>)"><i class="<?php echo $zjb_sp['goods_status']==0?'icon-off':'icon-ban-circle'; ?>"></i><?php echo $zjb_sp['goods_status']==0?'上架':'下架'; ?></a>
