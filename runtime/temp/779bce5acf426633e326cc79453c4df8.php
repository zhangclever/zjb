            ...
            <div class="row-fluid ">
                ...
                <div class="" data-tablet="span12 fix-offset" data-desktop="span6">
                    ...
                    <div class="portlet box grey ">
                        ...
                        <label>
                            <form action="<?php echo url('Video/video_list'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                搜 索 :
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover table-responsive"
                                ...
                                <tbody>
                                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$zjb_vo): $mod = ($i % 2 );++$i;?>
                                <tr class="odd gradeX ">
                                    <td style="vertical-align: middle !important;text-align: center;"><?php echo $zjb_vo['vname']; ?>
                                    </td>
                                    <td style="vertical-align: middle !important;text-align: center;"><img
                                            src="/static/admin/videos/<?php echo $zjb_vo['vimgpath']; ?>/<?php echo $zjb_vo['vimgname']; ?>" alt=""
                                            width="80"></td>
                                    <td style="vertical-align: middle !important;text-align: center;"><?php echo $zjb_vo['typename']; ?>
                                    </td>
                                    <td style="vertical-align: middle !important;text-align: center;">
                                        <a href="<?php echo url('Video/video_read',array('id'=>$zjb_vo['id'])); ?>"><i
                                                class="icon-eye-open"></i>查看</a>
                                        <a href="javascript:js_status(<?php echo $zjb_vo['id']; ?>,<?php echo $zjb_vo['status']; ?>)"><i
                                                class="<?php echo $zjb_vo['status']==0?'icon-off':'icon-ban-circle'; ?>"></i><?php echo $zjb_vo['status']==0?'上架':'下架'; ?></a>
                                        <a href="<?php echo url('Video/video_edit',array('id'=>$zjb_vo['id'])); ?>"><i
