...
<div id="page-wrap">
    <!-- SUB HEADER -->
    <section id="sub-header" class="section bg-parallax pt-80 pb-0" data-background="/static/home/img/news/1.jpg">
    ...
    <section class="section bg-white pt-60 pb-60">
        <div class="container">
            <div class="row">
            <?php if(is_array($healthy) || $healthy instanceof \think\Collection || $healthy instanceof \think\Paginator): $i = 0; $__LIST__ = $healthy;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                <div class="col-md-4">
                    <div class="section-header"><?php echo $vo['title']; ?></div>
                    <div class="post-thumbnail hover-link">
                        <img src="/static/admin/uploads/<?php echo $vo['images']; ?>" alt=""/>
                        <a href="<?php echo url('Healthy/content','id='.$vo['id']); ?>" class="overlay"><i class="ilmosys-link-2"></i></a>
                    </div><!--/ post-thumbnail -->
                    <div class="mb-30">
                        <p>时间：<?php echo $vo['ctimes']; ?></p>
                    </div>
                    <a href="<?php echo url('Healthy/content','id='.$vo['id']); ?>" class="btn btn-primary radius mb-30">阅读更多</a>
                </div><!-- /col -->
