<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:99:"F:\myphp_www\PHPTutorial\WWW\zjbwz\public/../application/admin\view\compensate\compensate_list.html";i:1515043374;s:88:"F:\myphp_www\PHPTutorial\WWW\zjbwz\public/../application/admin\view\public\link-css.html";i:1514966966;s:86:"F:\myphp_www\PHPTutorial\WWW\zjbwz\public/../application/admin\view\public\header.html";i:1514959430;s:89:"F:\myphp_www\PHPTutorial\WWW\zjbwz\public/../application/admin\view\public\left-menu.html";i:1515390145;s:86:"F:\myphp_www\PHPTutorial\WWW\zjbwz\public/../application/admin\view\public\footer.html";i:1514459584;s:89:"F:\myphp_www\PHPTutorial\WWW\zjbwz\public/../application/admin\view\public\script-js.html";i:1514964784;}*/ ?>
﻿<!DOCTYPE html>
                ...
                <div class="" data-tablet="span12 fix-offset" data-desktop="span6">
                    ...
                    <div class="portlet box grey ">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-user"></i>理赔通知</div>
                            <div class="actions">
                                <a href="<?php echo url('Compensate/Compensate_add'); ?>" class="btn blue"><i class="icon-pencil"></i>添加理赔</a>
                            </div>
                        </div>
                        <label>
                            <form action="<?php echo url('Compensate/Compensate_search'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                姓 名 :
                                <input name="name" type="text" aria-controls="sample_1">
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="sample_2">
                                ...
                                <tr>
                                    ...
                                    <th class="hidden-480" style="text-align: center;">信息内容</th>
                                    ...
                                    <th class="hidden-480" style="text-align: center;">意外出险原因</th>
                                    <th class="hidden-480" style="text-align: center;">赔付比例</th>
                                    <th class="hidden-480" style="text-align: center;">赔付金额</th>
                                    <th class="hidden-480" style="text-align: center;">赔付时间</th>
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <tr class="odd gradeX ">
                                    ...
                                    <td class="demo" style="text-align: center;" ><?php echo $vo['content']; ?></td>
                                    ...
                                    <td style="text-align: center;"><?php echo $vo['accident']; ?></td>
                                    <td style="text-align: center;"><?php echo $vo['ratio']; ?></td>
                                    <td style="text-align: center;"><?php echo $vo['sum']; ?></td>
                                    <td style="text-align: center;"><?php echo $vo['ptimes']; ?></td>
                                    <td style="text-align: center;">
                                        <a href="<?php echo url('Compensate/Compensate_see','id='.$vo['id']); ?>"><i class="icon-ban-circle"></i>查看</a>
                                        <a href="<?php echo url('Compensate/Compensate_status','id='.$vo['id']); ?>"><i class="icon-ban-circle"></i><?php if($vo['status'] == 0): ?> 禁用 <?php else: ?> 启用 <?php endif; ?></a>
                                        <a href="<?php echo url('Compensate/Compensate_edit','id='.$vo['id']); ?>"><i class="icon-pencil"></i>修改</a>
                                        <a onclick="return remove('<?php echo url('Compensate/Compensate_delete','id='.$vo['id']); ?>')"><i class="icon-trash"></i>删除</a>
                                     </td>
                                </tr>
