                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <article class="post format-standard">
                                <div class="post-thumbnail">
                                    ...
                                    <a href="<?php echo url('Healthy/content','id='.$vo['id']); ?>" class="overlay"></a>
                                </div><!--/ post-thumbnail -->

                                <header class="entry-header">
                                    <h2 class="entry-title h4"><a href="<?php echo url('Healthy/content','id='.$vo['id']); ?>"><?php echo $vo['title']; ?></a></h2>
                                ...
                                <div class="entry-content">
                                    <p><?php echo $vo['content']; ?>...<a href="<?php echo url('Healthy/content','id='.$vo['id']); ?>" class="more-link">Read more</a></p>
                                </div><!-- /entry-content -->
                    ...
                    <div id="sidebar" class="sidebar">
                        <div id="widget-area">
                            ...
                            <aside class="widget widget_categories">
                                <h3 class="widget-title h5"><a href="<?php echo url('Healthy/index'); ?>">健保专栏</a></h3>
                                <ul>
                                    <li class="cat-item">
                                        <ul class="children">
                                            <li class="cat-item">
                                                <a href="<?php echo url('Healthy/index','state=0'); ?>">健康资讯</a>
                                            </li>
                                            <li class="cat-item">
                                                <a href="<?php echo url('Healthy/index','state=1'); ?>">养生宝典</a>
                                            </li>
                                            <li class="cat-item">
                                                <a href="<?php echo url('Healthy/index','state=2'); ?>">家庭医生</a>
                                            </li>
                                            <li class="cat-item">
                                                <a href="<?php echo url('Healthy/index','state=3'); ?>">疾病筛查</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
