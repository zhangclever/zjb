                ...
                <div class="span12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i>公告查看</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form ">
                            ...
                            <form action="<?php echo url('Article/article_modify'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="title" value="<?php echo $notices['title']; ?>" data-required="1" readonly class="span6 m-wrap"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">信息联接地址<span class="required">*</span></label>
                                    <div class="controls">
                                        <input name="url" value="<?php echo $notices['url']; ?>" readonly type="text" class="span6 m-wrap"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <!-- <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="small m-wrap" disabled="disabled" name="status">
                                            <option value="0" <?php if($notices['status'] == 0): ?> selected="selected"  <?php endif; ?>>推荐</option>
                                            <option value="1" <?php if($notices['status'] == 1): ?> selected="selected"  <?php endif; ?>>不推荐</option>
                                        </select>
                                    </div>
                                </div> -->
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <img src='__PUBLIC__/uploads/<?php echo $notices['images']; ?>' height="100" width="100"/>
                                    </div>
                                </div>
                                <!-- <div class="control-group">
                                    <label class="control-label">信息图片<span class="required">*</span></label>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="content" disabled placeholder="请输入内容" class="medium m-wrap" rows="9"><?php echo $notices['content']; ?></textarea>
                                    </div>
                                </div>
