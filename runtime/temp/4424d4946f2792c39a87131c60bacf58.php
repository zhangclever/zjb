                ...
                <div class="" data-tablet="span12 fix-offset" data-desktop="span6">
                    ...
                    <div class="portlet box grey ">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-user"></i>广告管理</div>
                            <div class="actions">
                                <a href="<?php echo url('Advertise/advertise_add'); ?>" class="btn blue"><i class="icon-pencil"></i>添加广告</a>
                            </div>
                        </div>
                        <label>
                            <form action="<?php echo url('Advertise/advertise_list'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                搜 索 :
