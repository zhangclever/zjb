                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <article class="post format-standard">
                                <div class="post-thumbnail">
                                    ...
                                    <a href="<?php echo url('Dynamic/content','id='.$vo['id']); ?>" class="overlay"></a>
                                </div><!--/ post-thumbnail -->

                                <header class="entry-header">
                                    <h2 class="entry-title h4"><a href="<?php echo url('Dynamic/content','id='.$vo['id']); ?>"><?php echo $vo['title']; ?></a></h2>
                                    <span class="byline">发表<a href="#">中建宝</a> - </span>
                                    <span class="posted-on"><a href="#"><?php echo $vo['ctimes']; ?></a> - </span>
                                    <span>张贴<a href="#">在动态中心</a>, <a href="#">重要信息</a></span>
                                </header><!-- /header -->

                                <div class="entry-content">
                                    <p><?php echo $vo['content']; ?>...<a href="<?php echo url('Dynamic/content','id='.$vo['id']); ?>" class="more-link">Read more</a></p>
                                </div><!-- /entry-content -->
                    ...
                    <div id="sidebar" class="sidebar">
                        <div id="widget-area">
                            ...
                            <aside class="widget widget_categories">
                                <h3 class="widget-title h5"><a href="<?php echo url('Dynamic/index'); ?>">最新动态</a></h3>
                                <ul>
                                    <li class="cat-item">
                                        <ul class="children">
                                            <li class="cat-item">
                                                <a href="<?php echo url('Dynamic/index','state=0'); ?>">最新活动</a>
                                            </li>
                                            <li class="cat-item">
                                                <a href="<?php echo url('Dynamic/index','state=1'); ?>">行业动态</a>
                                            </li>
                                            <li class="cat-item">
                                                <a href="<?php echo url('Dynamic/index','state=2'); ?>">公告通知</a>
                                            </li>
                                            <li class="cat-item">
                                                <a href="<?php echo url('Dynamic/index','state=3'); ?>">公益活动</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
