                ...
                <div class="" data-tablet="span12 fix-offset" data-desktop="span6">
                    ...
                    <div class="portlet box grey ">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="<?php echo url('Dealer/dealer_add'); ?>" class="btn blue"><i class="icon-pencil"></i>添加经销商</a>
                            </div>
                        </div>
                        <label>
                            <form action="<?php echo url('Dealer/dealer_list'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                搜 索 :
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover table-responsive"
                                ...
                                <tbody>
                                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$zjb_di): $mod = ($i % 2 );++$i;?>
                                <tr class="odd gradeX ">
                                    <td style="vertical-align: middle !important;text-align: center;"><?php echo $zjb_di['duname']; ?>
                                    </td>
                                    <td style="vertical-align: middle !important;text-align: center;"><?php echo $zjb_di['dname']; ?>
                                    </td>
                                    <td style="vertical-align: middle !important;text-align: center;">
                                        <img src="/static/admin/<?php echo $zjb_di['dpath']; ?>/<?php echo $zjb_di['dimg']; ?>" alt="" width="80">
                                    </td>
                                    <td style="vertical-align: middle !important;text-align: center;"><?php echo $zjb_di['d_cid']; ?></td>
                                    <td style="vertical-align: middle !important;text-align: center;"><?php echo $zjb_di['d_state']==0?'未激活':'已激活'; ?></td>
                                    <td style="vertical-align: middle !important;text-align: center;">
                                        <a href="<?php echo url('Dealer/dealer_read',array('id'=>$zjb_di['id'])); ?>"><i
                                                class="icon-eye-open"></i>查看</a>
                                        <a href="javascript:js_status(<?php echo $zjb_di['id']; ?>,<?php echo $zjb_di['d_manage_state']; ?>)"><i
                                                class="<?php echo $zjb_di['d_manage_state']==0?'icon-ban-circle' : 'icon-off'; ?>"></i><?php echo $zjb_di['d_manage_state']==0?'禁用':'启用'; ?></a>
                                        <a href="<?php echo url('Dealer/dealer_edit',array('id'=>$zjb_di['id'])); ?>"><i
                                                class="icon-pencil"></i>编辑</a>
                                        <a href="javascript:del(<?php echo $zjb_di['id']; ?>)"><i class="icon-trash"></i>删除</a>
                                    </td>
                                </tr>
