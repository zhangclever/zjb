<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:91:"F:\myphp_www\PHPTutorial\WWW\zjb\public/../application/admin\view\Auth\auth_group_list.html";i:1516443802;s:76:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\link-css.html";i:1515743266;s:74:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\header.html";i:1515734283;s:77:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\left-menu.html";i:1516423192;s:74:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\footer.html";i:1516066794;s:77:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\script-js.html";i:1515745143;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="" data-tablet="span12 fix-offset" data-desktop="span6">
                    ...
                    <div class="portlet box grey ">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="<?php echo url('Auth/auth_group_add'); ?>" class="btn blue"><i class="icon-pencil"></i>添加角色</a>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover table-responsive" id="sample_2">
                                ...
                                <tbody>
                                <?php if(is_array($group_list) || $group_list instanceof \think\Collection || $group_list instanceof \think\Paginator): $i = 0; $__LIST__ = $group_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$gl): $mod = ($i % 2 );++$i;?>
                                <tr class="odd gradeX ">
                                    <td style="vertical-align: middle !important;text-align: center;"><?php echo $gl['id']; ?></td>
                                    <td style="vertical-align: middle !important;text-align: center;"><?php echo $gl['title']; ?></td>
                                    <td style="vertical-align: middle !important;text-align: center;">
                                        <a href="javascript:accredit(<?php echo $gl['id']; ?>)" class="btn blue mini">分配权限</a>
                                        <?php if($gl['id'] == '1'): else: ?>
                                        <a href="javascript:js_status(<?php echo $gl['id']; ?>,<?php echo $gl['status']; ?>)"><i class="<?php echo $gl['status']==0?'icon-off':'icon-ban-circle'; ?>"></i><?php echo $gl['status']==0?'启用':'禁用'; ?></a>
                                        <?php endif; ?>
                                        <a href="<?php echo url('Goods/goods_edit'); ?>"><i class="icon-pencil"></i>修改</a>
                                        <?php if($gl['id'] == '1'): else: ?>
                                        <a href="javascript:del(<?php echo $gl['id']; ?>)"><i class="icon-trash"></i>删除</a>
                                        <?php endif; ?>
                                    </td>
                                </tr>
...
<script>
    ...
    function accredit(id){
        layer.open({
            ...
            area: ['60%' , '90%'],
            maxmin: true,
            content: ['<?php echo url("Auth/auth_accredit"); ?>'+"?id="+id],
