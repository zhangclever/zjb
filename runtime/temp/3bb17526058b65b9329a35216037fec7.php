                ...
                <div class="span12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i>健保查看</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form ">
                            ...
                            <form action="<?php echo url('Article/article_modify'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="title" value="<?php echo $healthys['title']; ?>" data-required="1" readonly class="span6 m-wrap"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">信息联接地址<span class="required">*</span></label>
                                    <div class="controls">
                                        <input name="url" value="<?php echo $healthys['url']; ?>" readonly type="text" class="span6 m-wrap"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">健保类型<span class="required">*</span></label>
                                    <div class="controls">
                                        <select class="span6 m-wrap" disabled="disabled" name="state">
                                            <option disabled="disabled"></option>
                                            <option value="0" <?php if($healthys['state'] == 0): ?> selected="selected"  <?php endif; ?>>健康资讯</option>
                                            <option value="1" <?php if($healthys['state'] == 1): ?> selected="selected"  <?php endif; ?>>养生宝典</option>
                                            <option value="2" <?php if($healthys['state'] == 2): ?> selected="selected"  <?php endif; ?>>家庭医生</option>
                                            <option value="3" <?php if($healthys['state'] == 3): ?> selected="selected"  <?php endif; ?>>疾病筛查</option>
                                        </select>
                                    </div>
                                </div>
                                <!-- <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="small m-wrap" disabled="disabled" name="status">
                                            <option value="0" <?php if($healthys['status'] == 0): ?> selected="selected"  <?php endif; ?>>推荐</option>
                                            <option value="1" <?php if($healthys['status'] == 1): ?> selected="selected"  <?php endif; ?>>不推荐</option>
                                        </select>
                                    </div>
                                </div> -->
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <img src='__PUBLIC__/uploads/<?php echo $healthys['images']; ?>' height="100" width="100"/>
                                    </div>
                                </div>
                                <!-- <div class="control-group">
                                    <label class="control-label">信息图片<span class="required">*</span></label>
                                ...
                                <div class="control-group">
                                    <label class="control-label">健保内容</label>
                                    <div class="controls">
                                        <textarea name="content" disabled placeholder="请输入内容" class="medium m-wrap" rows="9"><?php echo $healthys['content']; ?></textarea>
                                    </div>
                                </div>
                                <!-- <div class="form-actions">
                                    <input class="form-control" type="hidden" name="id" value="<?php echo $healthys['id']; ?>">
