                ...
                <div class="" data-tablet="span12 fix-offset" data-desktop="span6">
                    ...
                    <div class="portlet box grey ">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="<?php echo url('Notice/notice_add'); ?>" class="btn blue"><i class="icon-pencil"></i>添加公告</a>
                            </div>
                        </div>
                        <label>
                            <form action="<?php echo url('Notice/notice_search'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                标 题 :
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <tr class="odd gradeX ">
                                    ...
                                    <td style="text-align: center;">
                                                                <?php switch($vo['state']): case "0": ?>通知公告<?php break; default: ?>default
                                                                <?php endswitch; ?>
                                    </td>
                                    <td style="text-align: center;"><?php echo $vo['ctimes']; ?></td>
                                    <td style="text-align: center;">
                                        <a href="<?php echo url('Notice/notice_see','id='.$vo['id']); ?>"><i class="icon-ban-circle"></i>查看</a>
                                        <a href="<?php echo url('Notice/notice_status','id='.$vo['id']); ?>"><i class="icon-ban-circle"></i><?php if($vo['status'] == 0): ?> 禁用 <?php else: ?> 启用 <?php endif; ?></a>
                                        <a href="<?php echo url('Notice/notice_edit','id='.$vo['id']); ?>"><i class="icon-pencil"></i>修改</a>
                                        <a onclick="return remove('<?php echo url('Notice/notice_delete','id='.$vo['id']); ?>')"><i class="icon-trash"></i>删除</a>
                                     </td>
                                </tr>
