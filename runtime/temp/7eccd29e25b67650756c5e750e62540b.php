                ...
                <div class="" data-tablet="span12 fix-offset" data-desktop="span6">
                    ...
                    <div class="portlet box grey ">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="<?php echo url('Advertise/advertise_type_add'); ?>" class="btn blue"><i class="icon-pencil"></i>添加分类</a>
                            </div>
                        </div>
                        <label>
                            <form action="<?php echo url('Advertise/advertise_type_search'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                广 告 类 型 :
