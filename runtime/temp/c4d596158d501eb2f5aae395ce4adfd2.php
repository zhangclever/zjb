                ...
                <div class="" data-tablet="span12 fix-offset" data-desktop="span6">
                    ...
                    <div class="portlet box grey ">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="<?php echo url('Member/member_add'); ?>" class="btn blue"><i class="icon-pencil"></i>添加会员</a>
                            </div>
                        </div>
                        <label>
                            <form action="<?php echo url('Member/member_list'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                搜 索 :
                                <input name="title" type="text" aria-controls="sample_1" value="<?php echo $title; ?>">
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover table-responsive"
                                ...
                                <tbody>
                                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$zjb_mb): $mod = ($i % 2 );++$i;?>
                                <tr class="odd gradeX ">
                                    <td style="vertical-align: middle !important;text-align: center;"><?php echo $zjb_mb['username']; ?>
                                    </td>
                                    <td style="vertical-align: middle !important;text-align: center;">
                                        <img src="/static/admin/<?php echo $zjb_mb['upath']; ?>/<?php echo $zjb_mb['uimg']; ?>" alt="" width="80">
                                    </td>
                                    <td style="vertical-align: middle !important;text-align: center;"><?php echo $zjb_mb['mleve']; ?></td>
                                    <td style="vertical-align: middle !important;text-align: center;"><?php echo $zjb_mb['dname']; ?></td>
