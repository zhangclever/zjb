<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:84:"F:\myphp_www\PHPTutorial\WWW\zjb\public/../application/admin\view\Auth\auth_add.html";i:1516428771;s:76:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\link-css.html";i:1515743266;s:74:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\header.html";i:1515734283;s:77:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\left-menu.html";i:1516423192;s:74:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\footer.html";i:1516066794;s:77:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\script-js.html";i:1515745143;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="span12">
                    ...
                    <div class="portlet box green">
                        ...
                        <div class="portlet-body form ">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo url('Auth/auth_info_add'); ?>" id="form_sample_2" method="post" class="form-horizontal" enctype="multipart/form-data" >
                                <div class="control-group">
                                    <div class="controls" data-toggle="tooltip" id="goodsName">
                                        <label class="control-label">权限中文名称<span class="required">*</span></label>
                                        <input type="text" name="title" data-required="1" class="span6 m-wrap"  value=""/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <label class="control-label">权限英文名<span class="required">*</span></label>
                                        <input name="name" type="text" class="span6 m-wrap"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <label class="control-label">权限类型<span class="required">*</span></label>
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        <label class="control-label">权限状态<span class="required">*</span></label>
