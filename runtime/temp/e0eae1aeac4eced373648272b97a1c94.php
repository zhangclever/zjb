                        ...
                        <main id="main">
                            <article class="post format-standard mb-40">
                                <div class="post-thumbnail">
                                    <img src="/static/admin/uploads/<?php echo $content['images']; ?>" alt="" />
                                    <!-- <a href="news-single.html" class="overlay"><i class="fa fa-link"></i></a> -->
                                    <span class="latest">通知</span>
                                </div><!--/ post-thumbnail -->

                                <header class="entry-header">
                                    <h2 class="entry-title h4"><a href="news-single.html"><?php echo $content['title']; ?></a></h2>
                                    <span class="byline">发表 <a href="#">中建宝</a> - </span>
                                    <span class="posted-on"><a href="#"><?php echo $content['ctimes']; ?></a> - </span>
                                    <span>张贴<a href="#">在理赔通知</a>,<a href="#">重要信息</a></span>
                                </header><!-- /header -->
                                
                                <div class="entry-content">
                                    <p>姓名:<?php echo $content['name']; ?></p>
                                    <p>意外出险原因:<?php echo $content['accident']; ?></p>
                                    <p>赔付比例:<?php echo $content['ratio']; ?></p>
                                    <p>赔付金额:<?php echo $content['sum']; ?></p>
                                    <p>赔付时间:<?php echo $content['ptimes']; ?></p>
                    ...
                    <div id="sidebar" class="sidebar">
                        <div id="widget-area">
                            <aside class="widget widget_search">
                                <form action="http://envato.megadrupal.com/html/shifa/search" method="post">
                                    <div class="input-group">
