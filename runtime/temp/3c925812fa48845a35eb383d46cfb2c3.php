<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:85:"F:\myphp_www\PHPTutorial\WWW\zjb\public/../application/admin\view\Auth\auth_list.html";i:1516433127;s:76:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\link-css.html";i:1515743266;s:74:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\header.html";i:1515734283;s:77:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\left-menu.html";i:1516423192;s:74:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\footer.html";i:1516066794;s:77:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\script-js.html";i:1515745143;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="" data-tablet="span12 fix-offset" data-desktop="span6">
                    ...
                    <div class="portlet box grey ">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="<?php echo url('Auth/auth_add'); ?>" class="btn blue"><i class="icon-pencil"></i>添加权限</a>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover table-responsive" id="sample_2">
                                ...
                                <tbody>
                                <?php if(is_array($rule_list) || $rule_list instanceof \think\Collection || $rule_list instanceof \think\Paginator): $i = 0; $__LIST__ = $rule_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rl): $mod = ($i % 2 );++$i;?>
                                <tr class="odd gradeX ">
                                    <td style="vertical-align: middle !important;text-align: center;"><?php echo $rl['id']; ?></td>
                                    <td style="vertical-align: middle !important;text-align: center;">
                                        <?php switch($rl['type']): case "1": ?><?php echo $rl['title']; break; case "2": ?>　　|-<?php echo $rl['title']; break; case "3": ?>　　　　|--<?php echo $rl['title']; break; endswitch; ?>
                                    </td>
                                    <td style="vertical-align: middle !important;text-align: center;"><?php echo $rl['name']; ?></td>
                                    <td style="vertical-align: middle !important;text-align: center;">
                                        <?php switch($rl['type']): case "1": ?>后台<?php break; case "2": ?><span style="color: #10a062">模块</span><?php break; case "3": ?><span style="color: #0e90d2">操作</span><?php break; endswitch; ?>
                                    </td>
                                    <td style="vertical-align: middle !important;text-align: center;">
                                        <a href="javascript:js_status(<?php echo $rl['id']; ?>,<?php echo $rl['status']; ?>)"><i class="<?php echo $rl['status']==0?'icon-off':'icon-ban-circle'; ?>"></i><?php echo $rl['status']==0?'启用':'禁用'; ?></a>
                                        <a href="<?php echo url('Auth/rule_edit'); ?>"><i class="icon-pencil"></i>修改</a>
                                        <a href="javascript:del(<?php echo $rl['id']; ?>)"><i class="icon-trash"></i>删除</a>
                                    </td>
                                </tr>
                            ...
                            <div class="pagination pagination-right" style="margin-bottom: 0;">
                                <ul>
                                    <li class="active"><?php echo $rule_list->render(); ?></li>
                                </ul>
                            </div>
                        </div>
