                ...
                <div class="span12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i>广告修改</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form ">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo url('Advertise/advertise_modify'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="title" value="<?php echo $advertises['title']; ?>" data-required="1" class="span6 m-wrap"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <?php if(is_array($data) || $data instanceof \think\Collection || $data instanceof \think\Paginator): $k = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?>
                                            <option value="<?php echo $vo['id']; ?>" <?php if($vo['id'] == $advertises['tid']): ?> selected="selected"  <?php endif; ?>><?php echo $vo['typename']; endforeach; endif; else: echo "" ;endif; ?>
                                        </select>
                                    </div>
                                </div>
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input name="url" value="<?php echo $advertises['url']; ?>" type="text" class="span6 m-wrap"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    <label class="control-label">广告广告内容</label>
                                    <div class="controls">
                                        <textarea name="content" placeholder="请输入内容" class="medium m-wrap" rows="9"><?php echo $advertises['content']; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-actions">
                                    <input class="form-control" type="hidden" name="id" value="<?php echo $advertises['id']; ?>">
