<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:97:"F:\myphp_www\PHPTutorial\WWW\zjbwz\public/../application/admin\view\advertise\advertise_list.html";i:1515388433;s:88:"F:\myphp_www\PHPTutorial\WWW\zjbwz\public/../application/admin\view\public\link-css.html";i:1514966966;s:86:"F:\myphp_www\PHPTutorial\WWW\zjbwz\public/../application/admin\view\public\header.html";i:1514959430;s:89:"F:\myphp_www\PHPTutorial\WWW\zjbwz\public/../application/admin\view\public\left-menu.html";i:1515390145;s:86:"F:\myphp_www\PHPTutorial\WWW\zjbwz\public/../application/admin\view\public\footer.html";i:1514459584;s:89:"F:\myphp_www\PHPTutorial\WWW\zjbwz\public/../application/admin\view\public\script-js.html";i:1514964784;}*/ ?>
﻿<!DOCTYPE html>
                ...
                <div class="" data-tablet="span12 fix-offset" data-desktop="span6">
                    ...
                    <div class="portlet box grey ">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-user"></i>轮播管理</div>
                            <div class="actions">
                                <a href="<?php echo url('Advertise/advertise_add'); ?>" class="btn blue"><i class="icon-pencil"></i>添加轮播</a>
                            </div>
                        </div>
                        <label>
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <tr class="odd gradeX ">
                                    ...
                                    <td style="text-align: center;" ><?php echo $vo['state']; ?></td>
                                    ...
                                    <td style="text-align: center;">
                                        <a href="<?php echo url('Advertise/advertise_see','id='.$vo['id']); ?>"><i class="icon-ban-circle"></i>查看</a>
                                        <a href="<?php echo url('Advertise/advertise_status','id='.$vo['id']); ?>"><i class="icon-ban-circle"></i><?php if($vo['status'] == 0): ?> 禁用 <?php else: ?> 启用 <?php endif; ?></a>
                                        <a href="<?php echo url('Advertise/advertise_edit','id='.$vo['id']); ?>"><i class="icon-pencil"></i>修改</a>
                                        <a onclick="return remove('<?php echo url('Advertise/advertise_delete','id='.$vo['id']); ?>')"><i class="icon-trash"></i>删除</a>
                                     </td>
                                </tr>
