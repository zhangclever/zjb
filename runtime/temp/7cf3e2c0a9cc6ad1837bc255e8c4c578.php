                ...
                <div class="span12">
                    ...
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i>健保添加</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form ">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo url('Healthy/healthy_insert'); ?>" id="form_sample_2" enctype="multipart/form-data" method="post" class="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="span6 m-wrap" name="state">
                                            ...
                                            <option value="1">养生宝典</option>
                                            <option value="2">家庭医生</option>
                                            <option value="3">疾病筛查</option>
                                        </select>
                                    </div>
                                </div>
                                <!-- <div class="control-group">
