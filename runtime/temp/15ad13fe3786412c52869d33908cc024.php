<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:88:"F:\myphp_www\PHPTutorial\WWW\zjb\public/../application/admin\view\Member\member_add.html";i:1516004706;s:76:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\link-css.html";i:1515743266;s:74:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\header.html";i:1515734283;s:77:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\left-menu.html";i:1515832511;s:74:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\footer.html";i:1515740892;s:77:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\script-js.html";i:1515745143;}*/ ?>
<!DOCTYPE html>
                            ...
                            <form action="<?php echo url('Member/member_info_add'); ?>" id="form_sample_2" method="post"
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls controls-row" style="margin-left: 250px;">
                                        ...
                                        <label class="radio">
                                            <input type="radio" name="sex" value="1" style="margin-left: 50px"/>
                                            女
                                        </label>
                                    </div>
                                    </div>
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        ...
                                        <input name="mobel" type="text" class="span6 m-wrap"/>
                                    </div>
                                </div>
                                <div class="control-group ">
                                    <div class="controls">
                                            <div id="distpicker">
                                                ...
                                                <select class="span3 m-wrap" id="province" name="province"
                                                    data-province="—— 省 ——"></select>
                                                <select class="span3 m-wrap" id="city" data-city="—— 市 ——" name="city"></select>
                                                <select class="span3 m-wrap" id="district"
                                                        data-district="—— 区 ——" name="district"></select>
                                        </div>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        ...
                                        <select class="span6 m-wrap" name="did">
                                            <?php if(is_array($mclist) || $mclist instanceof \think\Collection || $mclist instanceof \think\Paginator): $i = 0; $__LIST__ = $mclist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$videoc): $mod = ($i % 2 );++$i;?>
