<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:89:"F:\myphp_www\PHPTutorial\WWW\zjbwz\public/../application/admin\view\goods\goods_read.html";i:1515374337;s:88:"F:\myphp_www\PHPTutorial\WWW\zjbwz\public/../application/admin\view\public\link-css.html";i:1514966966;s:86:"F:\myphp_www\PHPTutorial\WWW\zjbwz\public/../application/admin\view\public\header.html";i:1514959430;s:89:"F:\myphp_www\PHPTutorial\WWW\zjbwz\public/../application/admin\view\public\left-menu.html";i:1515390145;s:86:"F:\myphp_www\PHPTutorial\WWW\zjbwz\public/../application/admin\view\public\footer.html";i:1514459584;s:89:"F:\myphp_www\PHPTutorial\WWW\zjbwz\public/../application/admin\view\public\script-js.html";i:1514964784;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="span12">
                    ...
                    <div class="portlet box green">
                        <div class="portlet-title">
                            ...
                            <div class="tools">
                                <a href="<?php echo url('Goods/goods_list'); ?>" >返回</a>
                            ...
                            <form action="" id="form_sample_2" method="post" class="form-horizontal" enctype="multipart/form-data" >
                                ...
                                <div class="control-group">
                                    <div class="controls" data-toggle="tooltip" id="goodsName">
                                        ...
                                        <input type="text" name="name" data-required="1" class="span6 m-wrap"  value="<?php echo $gi['name']; ?>" readonly/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <label class="control-label">商品价格<span class="required">*</span></label>
                                        <input name="price" type="text" class="span6 m-wrap" value="<?php echo $gi['price']; ?>" readonly/>
                                    </div>
                                    ...
                                    <div class="controls">
                                        ...
                                        <!--<div class="fileupload fileupload-new" data-provides="fileupload">-->
                                            <!--<div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">-->
                                                <img src="__PUBLIC__/uploads/<?php echo $gi['imgpath']; ?>/<?php echo $gi['imgname']; ?>" alt="" width="80" />
                                            <!--</div>-->
                                        <!--</div>-->
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        ...
                                        <input name="sales" type="text" class="span6 m-wrap" value="<?php echo $gi['sales']; ?>" readonly/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <label class="control-label">实结<span class="required">*</span></label>
                                        <input name="setlment" type="text" class="span6 m-wrap" value="<?php echo $gi['setlment']; ?>" readonly/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <label class="control-label">积分<span class="required">*</span></label>
                                        <input name="integral" type="text" class="span6 m-wrap" value="<?php echo $gi['integral']; ?>" readonly/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        <label class="control-label">关键字<span class="required">*</span></label>
                                        <input name="keyword" type="text" class="span6 m-wrap" value="<?php echo $gi['keyword']; ?>" readonly/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        ...
                                        <select class="span6 m-wrap" name="cid" readonly="readonly">
                                            <option value="<?php echo $gi['cid']; ?>"><?php echo $gi['catename']; ?></option>
                                        </select>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <div class="controls">
                                        ...
                                        <select class="small m-wrap" name="goods_state" readonly="readonly">
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        ...
                                        <textarea class="medium m-wrap" rows="3" name="descript" readonly="readonly"><?php echo $gi['descript']; ?></textarea>
                                    </div>
                                </div>
