<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:89:"F:\myphp_www\PHPTutorial\WWW\zjb\public/../application/admin\view\Member\member_list.html";i:1516006831;s:76:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\link-css.html";i:1515743266;s:74:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\header.html";i:1515734283;s:77:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\left-menu.html";i:1515832511;s:74:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\footer.html";i:1515740892;s:77:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\script-js.html";i:1515745143;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="" data-tablet="span12 fix-offset" data-desktop="span6">
                    ...
                    <div class="portlet box grey ">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-user"></i>会员列表</div>
                            <div class="actions">
                                <a href="<?php echo url('Member/member_add'); ?>" class="btn blue"><i class="icon-pencil"></i>添加视频</a>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover table-responsive"
                                ...
                                <thead>
                                <tr>
                                    <th class="hidden-480" style="text-align: center;">会员名称</th>
                                    <th class="hidden-480" style="text-align: center;">会员照片</th>
                                    <th class="hidden-480" style="text-align: center;">会员等级</th>
                                    <th class="hidden-480" style="text-align: center;">所属经销商</th>
                                    <th class="hidden-480" style="text-align: center;">是否激活</th>
                                    <th class="hidden-480" style="text-align: center;">操作</th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php if(is_array($mlist->data) || $mlist->data instanceof \think\Collection || $mlist->data instanceof \think\Paginator): $i = 0; $__LIST__ = $mlist->data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$zjb_mb): $mod = ($i % 2 );++$i;?>
                                <tr class="odd gradeX ">
                                    <td style="vertical-align: middle !important;text-align: center;"><?php echo $zjb_mb['username']; ?>
                                    </td>
                                    <td style="vertical-align: middle !important;text-align: center;">
                                        <img src="/public/static/admin/<?php echo $zjb_mb['upath']; ?>/<?php echo $zjb_mb['uimg']; ?>" alt="" width="80">
                                    </td>
                                    <td style="vertical-align: middle !important;text-align: center;"><?php echo $zjb_mb['mleve']; ?></td>
                                    <td style="vertical-align: middle !important;text-align: center;"><?php echo $zjb_mb['did']; ?></td>
                                    <td style="vertical-align: middle !important;text-align: center;"><?php echo $zjb_mb['ustate']==0?'未激活':'已激活'; ?></td>
                                    <td style="vertical-align: middle !important;text-align: center;">
                                        <a href="<?php echo url('Member/member_read',array('id'=>$zjb_mb['id'])); ?>"><i
                                                class="icon-eye-open"></i>查看</a>
                                        <a href="javascript:js_status(<?php echo $zjb_mb['id']; ?>,<?php echo $zjb_mb['status']; ?>)"><i
                                                class="<?php echo $zjb_mb['status']==0?'icon-ban-circle' : 'icon-off'; ?>"></i><?php echo $zjb_mb['status']==0?'禁用':'启用'; ?></a>
                                        <a href="<?php echo url('Member/member_edit',array('id'=>$zjb_mb['id'])); ?>"><i
                                                class="icon-pencil"></i>编辑</a>
                                        <a href="javascript:del(<?php echo $zjb_mb['id']; ?>)"><i class="icon-trash"></i>删除</a>
                                    </td>
                                </tr>
                            ...
                            <div class="pagination pagination-right" style="margin-bottom: 0;">
                                <ul>
                                    <li class="active"><?php echo $mlist->render; ?></li>
                                </ul>
                            </div>
                        </div>
                    </div>
