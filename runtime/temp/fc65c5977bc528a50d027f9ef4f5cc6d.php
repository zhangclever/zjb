<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:87:"F:\myphp_www\PHPTutorial\WWW\zjb\public/../application/admin\view\video\video_edit.html";i:1515814446;s:76:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\link-css.html";i:1515743266;s:74:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\header.html";i:1515734283;s:77:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\left-menu.html";i:1515814180;s:74:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\footer.html";i:1515740892;s:77:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\script-js.html";i:1515745143;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="span12 ">
                    ...
                    <div class="portlet box green ">
                        ...
                        <div class="portlet-body form ">
                            <!-- BEvoN FORM-->
                            <form action="<?php echo url('Video/video_info_edit'); ?>" id="form_sample_2" method="post" class="form-horizontal" enctype="multipart/form-data" >
                                ...
                                <div class="control-group">
                                    <div class="controls" data-toggle="tooltip" id="videosName">
                                        ...
                                        <input type="text" name="vname" data-required="1" class="span6 m-wrap"  value="<?php echo $vo['vname']; ?>"/>
                                    ...
                                    <div class="controls">
                                        ...
                                        <div class="fileupload fileupload-new" data-provides="fileupload">
                                            <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                                <img src="/public/static/admin/videos/<?php echo $vo['vimgpath']; ?>/<?php echo $vo['vimgname']; ?>" alt="" />
                                            </div>
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        ...
                                        <select class="span6 m-wrap" name="states">
                                            ...
                                            <?php if(is_array($video_cate) || $video_cate instanceof \think\Collection || $video_cate instanceof \think\Paginator): $i = 0; $__LIST__ = $video_cate;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vc): $mod = ($i % 2 );++$i;?>
                                            <option value="<?php echo $vc['id']; ?>">|-<?php echo $vc['typename']; ?></option>
                                ...
                                <div class="control-group">
                                    <div class="controls">
                                        ...
                                        <textarea class="medium m-wrap" rows="3" name="descript" ><?php echo $vo['descript']; ?></textarea>
                                    </div>
                                </div>
...
<script>
    ...
    $('#back').on('click',function () {
         location.href="<?php echo url('Video/video_list'); ?>";
    })
</script>
</html>