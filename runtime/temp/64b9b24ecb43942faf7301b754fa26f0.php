                ...
                <div class="span12">
                    ...
                    <div class="portlet box green">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i>动态添加</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form ">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo url('Dynamic/dynamic_insert'); ?>" id="form_sample_2" enctype="multipart/form-data" method="post" class="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="span6 m-wrap" name="state">
                                            <option value="0">最新活动</option>
                                            <option value="1">行业动态</option>
                                            <option value="2">公告通知</option>
                                            <option value="3">公益活动</option>
                                            <option value="4">视频播放</option>
                                        </select>
                                    </div>
                                </div>
                                <!-- <div class="control-group">
