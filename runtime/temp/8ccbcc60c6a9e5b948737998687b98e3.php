<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:88:"F:\myphp_www\PHPTutorial\WWW\zjb\public/../application/admin\view\admins\admin_list.html";i:1516436113;s:76:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\link-css.html";i:1515743266;s:74:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\header.html";i:1515734283;s:77:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\left-menu.html";i:1516423192;s:74:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\footer.html";i:1516066794;s:77:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\script-js.html";i:1515745143;}*/ ?>
﻿<!DOCTYPE html>
                ...
                <div class="" data-tablet="span12 fix-offset" data-desktop="span6">
                    ...
                    <div class="portlet box grey ">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="<?php echo url('Admins/admin_add'); ?>" class="btn blue"><i class="icon-pencil"></i>添加管理员</a>
                            </div>
                        </div>
                        <label>
                            <form action="<?php echo url('Admins/admin_list'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                姓 名 :
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover" id="sample_2">
                                ...
                                <tr>
                                    ...
                                    <th class="hidden-480" style="text-align: center;">账号</th>
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                                <tr class="odd gradeX ">
                                    ...
                                    <td style="text-align: center;">
                                        <a href="<?php echo url('Admins/admin_see','id='.$vo['id']); ?>"><i class="icon-ban-circle"></i>查看</a>
                                        <a href="<?php echo url('Admins/admin_edit','id='.$vo['id']); ?>"><i class="icon-pencil"></i>修改</a>
                                        <a href="javascript:remove(<?php echo $vo['id']; ?>)"><i class="icon-trash"></i>删除</a>
                                        <a href="javascript:accredit(<?php echo $vo['id']; ?>)"><i class="icon-trash"></i>授权</a>
                                     </td>
                                </tr>
