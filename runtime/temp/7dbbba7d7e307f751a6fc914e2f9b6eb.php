    ...
    <section class="section bg-white pt-50 pb-50">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-8" style="border: 1px solid red;height: 300px;" id="Home" hidden>
                    jlkjhlkjlkjlkj
                </div>
                <div class="col-md-8" style="border: 1px solid red;height: 300px;" id="Tutorials">
                    uoiuouoiuoo
                </div>
            </div>
        </div><!-- /container -->
...
<script>
    $("ul.nav>li").on('click',function(){
        $(this).siblings().removeClass('active').attr('class','active');
