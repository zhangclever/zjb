                ...
                <div class="" data-tablet="span12 fix-offset" data-desktop="span6">
                    ...
                    <div class="portlet box grey ">
                        <div class="portlet-title">
                            ...
                            <div class="actions">
                                <a href="<?php echo url('Manager/manager_add'); ?>" class="btn blue"><i class="icon-pencil"></i>添加</a>
                            </div>
                        </div>
                        <label>
                            <form action="<?php echo url('Manager/manager_list'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                姓 名 :
                                <input name="mname" type="text" aria-controls="sample_1" value="<?php echo $mname; ?>">
                        ...
                        <div class="portlet-body">
                            <table class="table table-striped table-bordered table-hover table-responsive"
                                ...
                                <tbody>
                                <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$zjb_ma): $mod = ($i % 2 );++$i;?>
                                <tr class="odd gradeX ">
                                    <td style="vertical-align: middle !important;text-align: center;"><?php echo $zjb_ma['mname']; ?>
                                    </td>
                                    <td style="vertical-align: middle !important;text-align: center;"><?php echo $zjb_ma['mmobel']; ?>
                                    </td>
                                    <td style="vertical-align: middle !important;text-align: center;">
                                        <a href="<?php echo url('Manager/manager_edit',array('id'=>$zjb_ma['id'])); ?>"><i
                                                class="icon-pencil"></i>编辑</a>
                                        <a href="javascript:del(<?php echo $zjb_ma['id']; ?>)"><i class="icon-trash"></i>删除</a>
                                    </td>
                                </tr>
