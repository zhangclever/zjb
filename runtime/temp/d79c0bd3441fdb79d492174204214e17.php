    ...
    <section id="sub-header" class="section bg-parallax pt-80 pb-0" data-background="">
        ...
        <div class="container">
            <div class="sub-wrapper">
                <h1>新闻中心</h1>
                <h4>包括消息、通讯、特写、速写（有的将速写纳入特写之列）等等；狭义上：消息是用概括的叙述方式，以较简明扼要的文字，迅速及时地报道附近新近发生的、有价值的事实，使一定人群了解。新闻一般包括标题、导语、主体、背景和结语五部分。</h4>
                    ...
                    <?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?>
                            <article class="post format-standard">
                                <div class="post-thumbnail">
                                    <img src="/static/admin/uploads/<?php echo $vo['images']; ?>" alt="" />
                                    <a href="<?php echo url('Article/content','id='.$vo['id']); ?>" class="overlay"></a>
                                </div><!--/ post-thumbnail -->

                                <header class="entry-header">
                                    <h2 class="entry-title h4"><a href="<?php echo url('Article/content','id='.$vo['id']); ?>"><?php echo $vo['title']; ?></a></h2>
                                    <span class="byline">发表<a href="#">中建宝</a> - </span>
                                    <span class="posted-on"><a href="#"><?php echo $vo['ctimes']; ?></a> - </span>
                                    <span>张贴<a href="#">在新闻中心</a>, <a href="#">重要信息</a></span>
                                </header><!-- /header -->

                                <div class="entry-content">
                                    <p><?php echo $vo['content']; ?>...<a href="<?php echo url('Article/content','id='.$vo['id']); ?>" class="more-link">Read more</a></p>
                                </div><!-- /entry-content -->

                                <footer class="entry-footer">
                                    <span class="favourite"><i class="ilmosys-heart"></i> <?php echo $vo['clicks']; ?> 点击量</span>
                                    <!-- <span class="comments-link"><i class="ilmosys-right-4"></i> <a href="#">12 评论</a></span>
                                    <span class="share-link"><i class="ilmosys-share-window"></i> <a href="#">分享</a></span> -->
                                </footer><!-- /entry-footer -->
                            </article><!-- /post -->
                    ...
                    <div id="sidebar" class="sidebar">
                        <div id="widget-area">
                            ...
                            <aside class="widget widget_categories">
                                <h3 class="widget-title h5"><a href="<?php echo url('Article/index'); ?>">新闻中心</a></h3>
                                <ul>
                                    <li class="cat-item">
                                        <ul class="children">
                                            <li class="cat-item">
                                                <a href="<?php echo url('Article/index','state=0'); ?>">新闻资讯</a>
                                            </li>
                                            <li class="cat-item">
                                                <a href="<?php echo url('Article/index','state=1'); ?>">热门新闻</a>
                                            </li>
                                            <li class="cat-item">
                                                <a href="<?php echo url('Article/index','state=2'); ?>">每日新闻</a>
                                            </li>
                                        </ul>
                                    </li>
                                </ul>
