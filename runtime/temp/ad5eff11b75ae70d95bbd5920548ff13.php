                ...
                <div class="span12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i>动态查看</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form ">
                            ...
                            <form action="<?php echo url('Article/article_modify'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="title" value="<?php echo $dynamics['title']; ?>" data-required="1" readonly class="span6 m-wrap"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">信息联接地址<span class="required">*</span></label>
                                    <div class="controls">
                                        <input name="url" value="<?php echo $dynamics['url']; ?>" readonly type="text" class="span6 m-wrap"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">动态类型<span class="required">*</span></label>
                                    <div class="controls">
                                        <select class="span6 m-wrap" disabled="disabled" name="state">
                                            <option disabled="disabled"></option>
                                            <option value="0" <?php if($dynamics['state'] == 0): ?> selected="selected"  <?php endif; ?>>最新活动</option>
                                            <option value="1" <?php if($dynamics['state'] == 1): ?> selected="selected"  <?php endif; ?>>行业动态</option>
                                            <option value="2" <?php if($dynamics['state'] == 2): ?> selected="selected"  <?php endif; ?>>公告通知</option>
                                            <option value="3" <?php if($dynamics['state'] == 3): ?> selected="selected"  <?php endif; ?>>公益活动</option>
                                            <option value="4" <?php if($dynamics['state'] == 4): ?> selected="selected"  <?php endif; ?>>视频播放</option>
                                        </select>
                                    </div>
                                </div>
                                <!-- <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <select class="small m-wrap" disabled="disabled" name="status">
                                            <option value="0" <?php if($dynamics['status'] == 0): ?> selected="selected"  <?php endif; ?>>推荐</option>
                                            <option value="1" <?php if($dynamics['status'] == 1): ?> selected="selected"  <?php endif; ?>>不推荐</option>
                                        </select>
                                    </div>
                                </div> -->
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <img src='__PUBLIC__/uploads/<?php echo $dynamics['images']; ?>' height="100" width="100"/>
                                    </div>
                                </div>
                                <!-- <div class="control-group">
                                    <label class="control-label">信息图片<span class="required">*</span></label>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <textarea name="content" disabled placeholder="请输入内容" class="medium m-wrap" rows="9"><?php echo $dynamics['content']; ?></textarea>
                                    </div>
                                </div>
                                <!-- <div class="form-actions">
                                    <input class="form-control" type="hidden" name="id" value="<?php echo $dynamics['id']; ?>">
