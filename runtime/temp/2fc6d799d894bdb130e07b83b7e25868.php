<?php if (!defined('THINK_PATH')) exit(); /*a:6:{s:87:"F:\myphp_www\PHPTutorial\WWW\zjb\public/../application/admin\view\admins\admin_see.html";i:1515638105;s:76:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\link-css.html";i:1515743266;s:74:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\header.html";i:1515734283;s:77:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\left-menu.html";i:1516423192;s:74:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\footer.html";i:1516066794;s:77:"F:\myphp_www\PHPTutorial\WWW\zjb\application\admin\view\Public\script-js.html";i:1515745143;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="span12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i>管理员查看</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form ">
                            ...
                            <form action="<?php echo url('Article/article_modify'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="username" value="<?php echo $admins['username']; ?>" data-required="1" readonly class="span6 m-wrap"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">手机号<span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="text" name="phone" value="<?php echo $admins['phone']; ?>" data-required="1" readonly class="span6 m-wrap"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">姓名<span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="text" name="name" value="<?php echo $admins['name']; ?>" data-required="1" readonly class="span6 m-wrap"/>
                                    </div>
                                </div>
                            </form>
                            <!-- END FORM-->
