                ...
                <div class="span12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i>理赔修改</div>
                            <div class="tools">
                        ...
                        <div class="portlet-body form ">
                            <!-- BEGIN FORM-->
                            <form action="<?php echo url('Compensate/Compensate_modify'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" name="name" value="<?php echo $compensates['name']; ?>" data-required="1" class="span6 m-wrap"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">标题<span class="required">*</span></label>
                                    <div class="controls">
                                        <input type="text" name="title" value="<?php echo $compensates['title']; ?>" data-required="1" class="span6 m-wrap"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">意外出险原因<span class="required">*</span></label>
                                    <div class="controls">
                                        <input name="accident" value="<?php echo $compensates['accident']; ?>" type="text" class="span6 m-wrap"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">赔付比例<span class="required">*</span></label>
                                    <div class="controls">
                                        <input name="ratio" value="<?php echo $compensates['ratio']; ?>" type="text" class="span6 m-wrap"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">赔付金额<span class="required">*</span></label>
                                    <div class="controls">
                                        <input name="sum" value="<?php echo $compensates['sum']; ?>" type="text" class="span6 m-wrap"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">赔付时间<span class="required">*</span></label>
                                    <div class="controls">
                                        <input name="ptimes" value="<?php echo $compensates['ptimes']; ?>" type="text" class="span6 m-wrap"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                    <label class="control-label">原(信息图片)<span class="required">*</span></label>
                                    <div class="controls">
                                        <img src='/static/admin/uploads/<?php echo $compensates['images']; ?>' height="100" width="100"/>
                                    </div>
                                </div>
                                <div class="control-group">
                                ...
                                <div class="control-group">
                                    <label class="control-label">理赔内容</label>
                                    <div class="controls">
                                        <textarea name="content" placeholder="请输入内容" class="medium m-wrap" rows="9"><?php echo $compensates['content']; ?></textarea>
                                    </div>
                                </div>
                                <div class="form-actions">
                                    <input class="form-control" type="hidden" name="id" value="<?php echo $compensates['id']; ?>">
