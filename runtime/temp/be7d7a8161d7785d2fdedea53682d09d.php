                        ...
                        <main id="main">
                            <article class="post format-standard mb-40">
                                <div class="post-thumbnail">
                                    ...
                                    <span class="latest">健保</span>
                                </div><!--/ post-thumbnail -->

                                <header class="entry-header">
                                    <h2 class="entry-title h4"><?php echo $content['title']; ?></h2>
                                    <span class="byline">发表 <a href="#">中建宝</a> - </span>
                                    <span class="posted-on"><a href="#"><?php echo $content['ctimes']; ?></a> - </span>
                                    <span>张贴<a href="#">在健保专栏</a>, <a href="#">重要信息</a></span>
                                </header><!-- /header -->
