            ...
            <div class="row-fluid ">
                ...
                <div class="" data-tablet="span12 fix-offset" data-desktop="span6">
                    ...
                    <div class="portlet box grey ">
                        ...
                        <label>
                            <form action="<?php echo url('Healthy/healthy_list'); ?>" enctype="multipart/form-data" method="post" class="form-horizontal">
                                标 题 :
                                <input name="title" value="<?php echo $title; ?>" type="text" aria-controls="sample_1">
